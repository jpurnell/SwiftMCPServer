# Coding Rules for SwiftMCPServer
...
- Testing imports: `Testing`, `@testable import SwiftMCPServer`
...
SwiftMCPServer is **Swift 5.9 compatible** while being **Swift 6.0 ready**. This dual-compatibility strategy ensures:
