# DocC Documentation Guidelines for SwiftMCPServer
...
- [ ] Includes all necessary imports (e.g., `import SwiftMCPServer`)
...
swift package --disable-sandbox preview-documentation --target SwiftMCPServer
...
Structure:
```
Sources/SwiftMCPServer/SwiftMCPServer.docc/
├── SwiftMCPServer.md              # Landing page
...
SwiftMCPServer provides tools for:
- [Core capability 1]
- [Core capability 2]
- [Core capability 3]
- [Core capability 4]
...
or [use case C], SwiftMCPServer offers a robust,
...
Learn the basics of using SwiftMCPServer for [primary use case].

## Overview

This tutorial covers:
- Installing SwiftMCPServer
- Creating models and data stores
- Basic calculations
- Building a simple workflow

### Add SwiftMCPServer to Your Project

Add the dependency to your `Package.swift`:

```swift
dependencies: [
    .package(url: "https://github.com/username/SwiftMCPServer", from: "2.0.0")
]
```
...
Understand and apply the fundamental calculations in SwiftMCPServer.

## Overview

SwiftMCPServer is built around a set of core concepts:
...
> 3. ✅ Added to the `SwiftMCPServer.md` landing page
...
SwiftMCPServer provides a comprehensive framework...
...
cd Sources/SwiftMCPServer/SwiftMCPServer.docc
...
**Why it happens**: Creating a `.md` file in the `.docc` directory is not enough. The article must be explicitly referenced in the main landing page (`SwiftMCPServer.md`) to appear in navigation.

**Solution**: After creating any new tutorial or guide, immediately add it to the `SwiftMCPServer.md` landing page in the appropriate section.

**Steps**:
1. Create your tutorial file (e.g., `NewFeatureGuide.md`)
2. Open `Sources/SwiftMCPServer/SwiftMCPServer.docc/SwiftMCPServer.md`
...
- [ ] Added to appropriate section in `SwiftMCPServer.md`
...
- [ ] Added to `SwiftMCPServer.md` landing page in appropriate `## Topics` section
...
This guide explains how to perform analysis using SwiftMCPServer's
core functions.
...
```markdown
<!-- In SwiftMCPServer.md landing page -->
